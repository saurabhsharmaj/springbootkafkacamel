...
public class MessageController {
	...
	public void get(@RequestParam String message ,HttpServletRequest request, HttpServletResponse response) {
		try {
			kafkaProducer.sendBody("direct:kafkaRoute", message+" This is a message from the /message route!"+UUID.randomUUID().toString());
